...
singularity exec \
	    ...
	    -config $path_to_workspace/inference-deen.yaml \
	    -model $path_to_workspace/model/de-en-fi-sv \
	    -src $path_to_data/flores200/devtest/deu_Latn.devtest \
	    -output $path_to_workspace/flores200.deu.last.eng
